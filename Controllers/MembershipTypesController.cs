...
namespace Vidly.Controllers
{
    public class MembershipTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SingUpFee,DurationInMonths,DiscountRate")] MembershipType membershipType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SingUpFee,DurationInMonths,DiscountRate")] MembershipType membershipType)
        {
